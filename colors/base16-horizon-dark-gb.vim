...
if !has("gui_running")
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-horizon-dark-gb.sh"
  endif
endif
...
hi clear
syntax reset
let g:colors_name = "base16-horizon-dark-gb"
...
call <sid>hi("WildMenu",      s:gui08, s:gui0A, s:cterm07, s:cterm03, "", "")
...
call <sid>hi("TabLine",       s:gui03, s:gui01, s:cterm05, s:cterm02, "none", "")
call <sid>hi("TabLineFill",   s:gui03, s:gui01, s:cterm05, s:cterm02, "none", "")
call <sid>hi("TabLineSel",    s:gui0B, s:gui01, s:cterm07, s:cterm03, "none", "")
